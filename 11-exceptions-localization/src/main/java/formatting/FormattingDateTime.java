...
public class FormattingDateTime {
    ...
    public static void main(String[] args) {
        ...
        ZonedDateTime zonedDateTime = ZonedDateTime.of(localDateTime, ZoneId.of("Europe/Brussels"));
        ...
        System.out.println(DateTimeFormatter.ofPattern("dd/MM/yyyy h:mma z").format(zonedDateTime)); // z = time zone name (abbreviation)
        System.out.println(zonedDateTime.format(DateTimeFormatter.ofPattern("dd/MM/yyyy h:mma zZ"))); // Z = time zone offset
        System.out.println("----------");

        // add custom text values
        DateTimeFormatter formatter = DateTimeFormatter.ofPattern("'Party:' dd/MM/yyyy 'at' h:mma");
